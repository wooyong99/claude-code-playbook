...
| 루프를 돌린다 | `/implement` 커스텀 커맨드 | 작성 → 검토 → 수정을 PASS까지 자동 수렴 |
...
| 5. 운용 흐름 | [WORKFLOW.md](WORKFLOW.md) | `/implement` 커맨드로 기능을 구현할 때 |
...
# 3. 예시 커맨드 — 요구사항을 마일스톤 단위로 분해·구현
/implement "카테고리 CRUD를 추가해줘"
```
